...
// CheckObjectExistsAPI checks if the given object ID exists in the repository using the CommitService.
func CheckObjectExistsAPI(t *testing.T, ctx context.Context, commitClient gitalypb.CommitServiceClient, repo *gitalypb.Repository, objectID git.ObjectID, expectedExists bool) {
	t.Helper()
