...
type Manager interface {
	...
	// OffloadRepository offloads a repository's objects onto a cloud object storage
	OffloadRepository(context.Context, *localrepo.Repo, config.OffloadHouseKeepingConfig) error
	// RehydrateRepository restores a repository's objects back to Gitaly storage
	RehydrateRepository(context.Context, *localrepo.Repo, config.OffloadHouseKeepingConfig) error
}
