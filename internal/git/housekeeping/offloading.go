...
// SetOffloadingGitConfig add a new promisor remote in the git config of the offloaded repository.
func SetOffloadingGitConfig(ctx context.Context, repo *localrepo.Repo) error {
	return nil
}

// ResetOffloadingGitConfig remote the promisor remote from the offloaded repository.
func ResetOffloadingGitConfig(ctx context.Context, repo *localrepo.Repo) error {
	return nil
}

// AddOffloadTransientAlternate add an alternate in the offloaded repository. This alternate
...
// RemoveFromOffloadingStorage remove files from offloading storage
