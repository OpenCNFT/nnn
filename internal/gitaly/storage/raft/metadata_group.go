...
func (g *metadataRaftGroup) RegisterStorage(storageName string) (*gitalypb.Storage, error) {
	...
	result, response, err := g.requestRegisterStorage(storageName, g.clusterConfig)
	if err != nil {
...
func (g *metadataRaftGroup) requestRegisterStorage(storageName string, clusterCfg config.Raft) (updateResult, *gitalypb.RegisterStorageResponse, error) {
