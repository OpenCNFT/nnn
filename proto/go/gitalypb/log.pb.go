...
type LogEntry struct {
	...
	// repository_offloading, when set, signifies that this log entry contains details of an offloading task,
	// where repository data is being moved to an offloading storage.
	...
	// repository_rehydrating, when set, signifies that this log entry contains details of a rehydrating task,
	// where previously offloaded data is being restored back to the local storage.
	RepositoryRehydrating *LogEntry_RepositoryRehydrating `protobuf:"bytes,12,opt,name=repository_rehydrating,json=repositoryRehydrating,proto3" json:"repository_rehydrating,omitempty"`
}
...
func (x *LogEntry) GetRepositoryRehydrating() *LogEntry_RepositoryRehydrating {
	if x != nil {
		return x.RepositoryRehydrating
	}
	return nil
}
...
// RepositoryOffloading models a repository offloading.
type LogEntry_RepositoryOffloading struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// new_pack_files are the new pack files need to put in objects/pack dir.
...
// RepositoryRehydrating models a repository rehydrating.
type LogEntry_RepositoryRehydrating struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *LogEntry_RepositoryRehydrating) Reset() {
	*x = LogEntry_RepositoryRehydrating{}
	mi := &file_log_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LogEntry_RepositoryRehydrating) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogEntry_RepositoryRehydrating) ProtoMessage() {}

func (x *LogEntry_RepositoryRehydrating) ProtoReflect() protoreflect.Message {
	mi := &file_log_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogEntry_RepositoryRehydrating.ProtoReflect.Descriptor instead.
func (*LogEntry_RepositoryRehydrating) Descriptor() ([]byte, []int) {
...
func (*LogEntry_Operation_CreateHardLink) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0, 5, 0}
}
...
func (*LogEntry_Operation_RemoveDirectoryEntry) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0, 5, 1}
}
...
func (*LogEntry_Operation_CreateDirectory) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0, 5, 2}
}
...
func (*LogEntry_Operation_SetKey) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0, 5, 3}
}
...
func (*LogEntry_Operation_DeleteKey) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0, 5, 4}
}
...
var file_log_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x79, 0x22, 0xf9, 0x0f, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x07, 0x63, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x73, 0x1a, 0x67, 0x0a, 0x06, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x25,
	...
	,
	...
	0x70, 0x68, 0x73, 0x1a, 0xf9, 0x05, 0x0a, 0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	,
	...
	0x65, 0x1a, 0x30, 0x0a, 0x06, 0x53, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b,
	0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x1a, 0x1d, 0x0a, 0x09, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4b, 0x65, 0x79,
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x42, 0x0b, 0x0a, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22,
...
var file_log_proto_goTypes = []any{
	...
	(*LogEntry_RepositoryRehydrating)(nil),          // 5: gitaly.LogEntry.RepositoryRehydrating
	(*LogEntry_Housekeeping)(nil),                   // 6: gitaly.LogEntry.Housekeeping
	(*LogEntry_Operation)(nil),                      // 7: gitaly.LogEntry.Operation
	(*LogEntry_ReferenceTransaction_Change)(nil),    // 8: gitaly.LogEntry.ReferenceTransaction.Change
	(*LogEntry_Housekeeping_PackRefs)(nil),          // 9: gitaly.LogEntry.Housekeeping.PackRefs
	(*LogEntry_Housekeeping_Repack)(nil),            // 10: gitaly.LogEntry.Housekeeping.Repack
	(*LogEntry_Housekeeping_WriteCommitGraphs)(nil), // 11: gitaly.LogEntry.Housekeeping.WriteCommitGraphs
	(*LogEntry_Operation_CreateHardLink)(nil),       // 12: gitaly.LogEntry.Operation.CreateHardLink
	(*LogEntry_Operation_RemoveDirectoryEntry)(nil), // 13: gitaly.LogEntry.Operation.RemoveDirectoryEntry
...
var file_log_proto_depIdxs = []int32{
	...
	6,  // 2: gitaly.LogEntry.housekeeping:type_name -> gitaly.LogEntry.Housekeeping
	7,  // 3: gitaly.LogEntry.operations:type_name -> gitaly.LogEntry.Operation
	4,  // 4: gitaly.LogEntry.repository_offloading:type_name -> gitaly.LogEntry.RepositoryOffloading
	5,  // 5: gitaly.LogEntry.repository_rehydrating:type_name -> gitaly.LogEntry.RepositoryRehydrating
	8,  // 6: gitaly.LogEntry.ReferenceTransaction.changes:type_name -> gitaly.LogEntry.ReferenceTransaction.Change
	9,  // 7: gitaly.LogEntry.Housekeeping.pack_refs:type_name -> gitaly.LogEntry.Housekeeping.PackRefs
	10, // 8: gitaly.LogEntry.Housekeeping.repack:type_name -> gitaly.LogEntry.Housekeeping.Repack
	11, // 9: gitaly.LogEntry.Housekeeping.write_commit_graphs:type_name -> gitaly.LogEntry.Housekeeping.WriteCommitGraphs
	12, // 10: gitaly.LogEntry.Operation.create_hard_link:type_name -> gitaly.LogEntry.Operation.CreateHardLink
	13, // 11: gitaly.LogEntry.Operation.remove_directory_entry:type_name -> gitaly.LogEntry.Operation.RemoveDirectoryEntry
...
func file_log_proto_init() {
	...
	file_log_proto_msgTypes[7].OneofWrappers = []any{
