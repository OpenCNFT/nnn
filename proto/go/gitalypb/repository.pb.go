...
// OffloadRequest is the request for the OffloadRepository RPC
type OffloadRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// repository is the repository whose object store we want to offloaded.
	Repository *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	// filter is the filter used when repacking, default to blob:none.
	// More info can be found at https://git-scm.com/docs/git-repack#Documentation/git-repack.txt---filterltfilter-specgt
	Filter string `protobuf:"bytes,2,opt,name=filter,proto3" json:"filter,omitempty"`
	// bucket is the bucket name of the cloud object storage
...
// OffloadResponse is the response for the OffloadRepository RPC
...
// RehydrateRequest is the request for the RehydrateRepository RPC
type RehydrateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// repository is the repository whose object store we want to download back.
	Repository *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	// bucket is the bucket name of the cloud object storage
...
func (x *RehydrateRequest) GetRepository() *Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
func (x *RehydrateRequest) GetBucket() string {
	if x != nil {
		return x.Bucket
	}
	return ""
...
// RehydrateResponse is the response for the RehydrateRepository RPC
...
var file_repository_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_repository_proto_goTypes = []any{
	...
	(*RehydrateRequest)(nil),                        // 91: gitaly.RehydrateRequest
	(*RehydrateResponse)(nil),                       // 92: gitaly.RehydrateResponse
	...
	(*GetRawChangesResponse_RawChange)(nil),         // 95: gitaly.GetRawChangesResponse.RawChange
	(*BackupRepositoryResponse_SkippedError)(nil),   // 96: gitaly.BackupRepositoryResponse.SkippedError
	(*RestoreRepositoryResponse_SkippedError)(nil),  // 97: gitaly.RestoreRepositoryResponse.SkippedError
	(*GetFileAttributesResponse_AttributeInfo)(nil), // 98: gitaly.GetFileAttributesResponse.AttributeInfo
	(*Repository)(nil),                              // 99: gitaly.Repository
	(ObjectFormat)(0),                               // 100: gitaly.ObjectFormat
	(*RemoteNotFoundError)(nil),                     // 101: gitaly.RemoteNotFoundError
}
var file_repository_proto_depIdxs = []int32{
	99,  // 0: gitaly.RepositoryExistsRequest.repository:type_name -> gitaly.Repository
	99,  // 1: gitaly.RepositorySizeRequest.repository:type_name -> gitaly.Repository
	99,  // 2: gitaly.RepositoryInfoRequest.repository:type_name -> gitaly.Repository
	...
	99,  // 5: gitaly.ObjectsSizeRequest.repository:type_name -> gitaly.Repository
	99,  // 6: gitaly.ObjectFormatRequest.repository:type_name -> gitaly.Repository
	100, // 7: gitaly.ObjectFormatResponse.format:type_name -> gitaly.ObjectFormat
	99,  // 8: gitaly.FetchBundleRequest.repository:type_name -> gitaly.Repository
	99,  // 9: gitaly.FetchRemoteRequest.repository:type_name -> gitaly.Repository
	70,  // 10: gitaly.FetchRemoteRequest.remote_params:type_name -> gitaly.Remote
	99,  // 11: gitaly.CreateRepositoryRequest.repository:type_name -> gitaly.Repository
	100, // 12: gitaly.CreateRepositoryRequest.object_format:type_name -> gitaly.ObjectFormat
	99,  // 13: gitaly.GetArchiveRequest.repository:type_name -> gitaly.Repository
	0,   // 14: gitaly.GetArchiveRequest.format:type_name -> gitaly.GetArchiveRequest.Format
	99,  // 15: gitaly.HasLocalBranchesRequest.repository:type_name -> gitaly.Repository
	99,  // 16: gitaly.FetchSourceBranchRequest.repository:type_name -> gitaly.Repository
	99,  // 17: gitaly.FetchSourceBranchRequest.source_repository:type_name -> gitaly.Repository
	99,  // 18: gitaly.FsckRequest.repository:type_name -> gitaly.Repository
	99,  // 19: gitaly.WriteRefRequest.repository:type_name -> gitaly.Repository
	99,  // 20: gitaly.FindMergeBaseRequest.repository:type_name -> gitaly.Repository
	99,  // 21: gitaly.CreateForkRequest.repository:type_name -> gitaly.Repository
	99,  // 22: gitaly.CreateForkRequest.source_repository:type_name -> gitaly.Repository
	99,  // 23: gitaly.CreateRepositoryFromURLRequest.repository:type_name -> gitaly.Repository
	101, // 24: gitaly.CreateRepositoryFromURLError.remote_not_found:type_name -> gitaly.RemoteNotFoundError
	99,  // 25: gitaly.CreateBundleRequest.repository:type_name -> gitaly.Repository
	99,  // 26: gitaly.CreateBundleFromRefListRequest.repository:type_name -> gitaly.Repository
	99,  // 27: gitaly.GenerateBundleURIRequest.repository:type_name -> gitaly.Repository
	99,  // 28: gitaly.GetConfigRequest.repository:type_name -> gitaly.Repository
	99,  // 29: gitaly.RestoreCustomHooksRequest.repository:type_name -> gitaly.Repository
	99,  // 30: gitaly.SetCustomHooksRequest.repository:type_name -> gitaly.Repository
	99,  // 31: gitaly.BackupCustomHooksRequest.repository:type_name -> gitaly.Repository
	99,  // 32: gitaly.GetCustomHooksRequest.repository:type_name -> gitaly.Repository
	99,  // 33: gitaly.CreateRepositoryFromBundleRequest.repository:type_name -> gitaly.Repository
	99,  // 34: gitaly.FindLicenseRequest.repository:type_name -> gitaly.Repository
	99,  // 35: gitaly.GetInfoAttributesRequest.repository:type_name -> gitaly.Repository
	99,  // 36: gitaly.CalculateChecksumRequest.repository:type_name -> gitaly.Repository
	99,  // 37: gitaly.GetSnapshotRequest.repository:type_name -> gitaly.Repository
	99,  // 38: gitaly.CreateRepositoryFromSnapshotRequest.repository:type_name -> gitaly.Repository
	99,  // 39: gitaly.GetRawChangesRequest.repository:type_name -> gitaly.Repository
	95,  // 40: gitaly.GetRawChangesResponse.raw_changes:type_name -> gitaly.GetRawChangesResponse.RawChange
	99,  // 41: gitaly.SearchFilesByNameRequest.repository:type_name -> gitaly.Repository
	99,  // 42: gitaly.SearchFilesByContentRequest.repository:type_name -> gitaly.Repository
	99,  // 43: gitaly.GetObjectDirectorySizeRequest.repository:type_name -> gitaly.Repository
	99,  // 44: gitaly.RemoveRepositoryRequest.repository:type_name -> gitaly.Repository
	99,  // 45: gitaly.ReplicateRepositoryRequest.repository:type_name -> gitaly.Repository
	99,  // 46: gitaly.ReplicateRepositoryRequest.source:type_name -> gitaly.Repository
	99,  // 47: gitaly.OptimizeRepositoryRequest.repository:type_name -> gitaly.Repository
	2,   // 48: gitaly.OptimizeRepositoryRequest.strategy:type_name -> gitaly.OptimizeRepositoryRequest.Strategy
	99,  // 49: gitaly.PruneUnreachableObjectsRequest.repository:type_name -> gitaly.Repository
	99,  // 50: gitaly.BackupRepositoryRequest.repository:type_name -> gitaly.Repository
	99,  // 51: gitaly.BackupRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	99,  // 52: gitaly.RestoreRepositoryRequest.repository:type_name -> gitaly.Repository
	99,  // 53: gitaly.RestoreRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	99,  // 54: gitaly.GetFileAttributesRequest.repository:type_name -> gitaly.Repository
	98,  // 55: gitaly.GetFileAttributesResponse.attribute_infos:type_name -> gitaly.GetFileAttributesResponse.AttributeInfo
	99,  // 56: gitaly.FastExportRequest.repository:type_name -> gitaly.Repository
	99,  // 57: gitaly.OffloadRequest.repository:type_name -> gitaly.Repository
	99,  // 58: gitaly.RehydrateRequest.repository:type_name -> gitaly.Repository
	1,   // 59: gitaly.GetRawChangesResponse.RawChange.operation:type_name -> gitaly.GetRawChangesResponse.RawChange.Operation
	3,   // 60: gitaly.RepositoryService.RepositoryExists:input_type -> gitaly.RepositoryExistsRequest
	5,   // 61: gitaly.RepositoryService.RepositorySize:input_type -> gitaly.RepositorySizeRequest
	7,   // 62: gitaly.RepositoryService.RepositoryInfo:input_type -> gitaly.RepositoryInfoRequest
	9,   // 63: gitaly.RepositoryService.ObjectsSize:input_type -> gitaly.ObjectsSizeRequest
	11,  // 64: gitaly.RepositoryService.ObjectFormat:input_type -> gitaly.ObjectFormatRequest
	15,  // 65: gitaly.RepositoryService.FetchRemote:input_type -> gitaly.FetchRemoteRequest
	17,  // 66: gitaly.RepositoryService.CreateRepository:input_type -> gitaly.CreateRepositoryRequest
	19,  // 67: gitaly.RepositoryService.GetArchive:input_type -> gitaly.GetArchiveRequest
	21,  // 68: gitaly.RepositoryService.HasLocalBranches:input_type -> gitaly.HasLocalBranchesRequest
	23,  // 69: gitaly.RepositoryService.FetchSourceBranch:input_type -> gitaly.FetchSourceBranchRequest
	25,  // 70: gitaly.RepositoryService.Fsck:input_type -> gitaly.FsckRequest
	27,  // 71: gitaly.RepositoryService.WriteRef:input_type -> gitaly.WriteRefRequest
	29,  // 72: gitaly.RepositoryService.FindMergeBase:input_type -> gitaly.FindMergeBaseRequest
	31,  // 73: gitaly.RepositoryService.CreateFork:input_type -> gitaly.CreateForkRequest
	33,  // 74: gitaly.RepositoryService.CreateRepositoryFromURL:input_type -> gitaly.CreateRepositoryFromURLRequest
	36,  // 75: gitaly.RepositoryService.CreateBundle:input_type -> gitaly.CreateBundleRequest
	38,  // 76: gitaly.RepositoryService.CreateBundleFromRefList:input_type -> gitaly.CreateBundleFromRefListRequest
	40,  // 77: gitaly.RepositoryService.GenerateBundleURI:input_type -> gitaly.GenerateBundleURIRequest
	13,  // 78: gitaly.RepositoryService.FetchBundle:input_type -> gitaly.FetchBundleRequest
	52,  // 79: gitaly.RepositoryService.CreateRepositoryFromBundle:input_type -> gitaly.CreateRepositoryFromBundleRequest
	42,  // 80: gitaly.RepositoryService.GetConfig:input_type -> gitaly.GetConfigRequest
	54,  // 81: gitaly.RepositoryService.FindLicense:input_type -> gitaly.FindLicenseRequest
	56,  // 82: gitaly.RepositoryService.GetInfoAttributes:input_type -> gitaly.GetInfoAttributesRequest
	58,  // 83: gitaly.RepositoryService.CalculateChecksum:input_type -> gitaly.CalculateChecksumRequest
	60,  // 84: gitaly.RepositoryService.GetSnapshot:input_type -> gitaly.GetSnapshotRequest
	62,  // 85: gitaly.RepositoryService.CreateRepositoryFromSnapshot:input_type -> gitaly.CreateRepositoryFromSnapshotRequest
	64,  // 86: gitaly.RepositoryService.GetRawChanges:input_type -> gitaly.GetRawChangesRequest
	68,  // 87: gitaly.RepositoryService.SearchFilesByContent:input_type -> gitaly.SearchFilesByContentRequest
	66,  // 88: gitaly.RepositoryService.SearchFilesByName:input_type -> gitaly.SearchFilesByNameRequest
	44,  // 89: gitaly.RepositoryService.RestoreCustomHooks:input_type -> gitaly.RestoreCustomHooksRequest
	45,  // 90: gitaly.RepositoryService.SetCustomHooks:input_type -> gitaly.SetCustomHooksRequest
	48,  // 91: gitaly.RepositoryService.BackupCustomHooks:input_type -> gitaly.BackupCustomHooksRequest
	49,  // 92: gitaly.RepositoryService.GetCustomHooks:input_type -> gitaly.GetCustomHooksRequest
	71,  // 93: gitaly.RepositoryService.GetObjectDirectorySize:input_type -> gitaly.GetObjectDirectorySizeRequest
	73,  // 94: gitaly.RepositoryService.RemoveRepository:input_type -> gitaly.RemoveRepositoryRequest
	75,  // 95: gitaly.RepositoryService.ReplicateRepository:input_type -> gitaly.ReplicateRepositoryRequest
	77,  // 96: gitaly.RepositoryService.OptimizeRepository:input_type -> gitaly.OptimizeRepositoryRequest
	79,  // 97: gitaly.RepositoryService.PruneUnreachableObjects:input_type -> gitaly.PruneUnreachableObjectsRequest
	81,  // 98: gitaly.RepositoryService.BackupRepository:input_type -> gitaly.BackupRepositoryRequest
	83,  // 99: gitaly.RepositoryService.RestoreRepository:input_type -> gitaly.RestoreRepositoryRequest
	85,  // 100: gitaly.RepositoryService.GetFileAttributes:input_type -> gitaly.GetFileAttributesRequest
	87,  // 101: gitaly.RepositoryService.FastExport:input_type -> gitaly.FastExportRequest
	89,  // 102: gitaly.RepositoryService.OffloadRepository:input_type -> gitaly.OffloadRequest
	91,  // 103: gitaly.RepositoryService.RehydrateRepository:input_type -> gitaly.RehydrateRequest
	...
	16,  // 109: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	18,  // 110: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	20,  // 111: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	22,  // 112: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	24,  // 113: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	26,  // 114: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	28,  // 115: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	30,  // 116: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	32,  // 117: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	34,  // 118: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	37,  // 119: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	39,  // 120: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	41,  // 121: gitaly.RepositoryService.GenerateBundleURI:output_type -> gitaly.GenerateBundleURIResponse
	14,  // 122: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	53,  // 123: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	43,  // 124: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	55,  // 125: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	57,  // 126: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	59,  // 127: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	61,  // 128: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	63,  // 129: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	65,  // 130: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	69,  // 131: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	67,  // 132: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	46,  // 133: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	47,  // 134: gitaly.RepositoryService.SetCustomHooks:output_type -> gitaly.SetCustomHooksResponse
	50,  // 135: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	51,  // 136: gitaly.RepositoryService.GetCustomHooks:output_type -> gitaly.GetCustomHooksResponse
	72,  // 137: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	74,  // 138: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	76,  // 139: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	78,  // 140: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	80,  // 141: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	82,  // 142: gitaly.RepositoryService.BackupRepository:output_type -> gitaly.BackupRepositoryResponse
	84,  // 143: gitaly.RepositoryService.RestoreRepository:output_type -> gitaly.RestoreRepositoryResponse
	86,  // 144: gitaly.RepositoryService.GetFileAttributes:output_type -> gitaly.GetFileAttributesResponse
	88,  // 145: gitaly.RepositoryService.FastExport:output_type -> gitaly.FastExportResponse
	90,  // 146: gitaly.RepositoryService.OffloadRepository:output_type -> gitaly.OffloadResponse
	92,  // 147: gitaly.RepositoryService.RehydrateRepository:output_type -> gitaly.RehydrateResponse
