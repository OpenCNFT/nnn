...
type RepositoryServiceClient interface {
	...
	// OffloadRepository runs a serials of operations to offload part of the repository's
	// object storage on to a cloud object storage.
	OffloadRepository(ctx context.Context, in *OffloadRequest, opts ...grpc.CallOption) (*OffloadResponse, error)
	// RehydrateRepository is the reverse operation of OffloadRepository. It brings back
	// the offloaded object storage back to Gitaly node.
