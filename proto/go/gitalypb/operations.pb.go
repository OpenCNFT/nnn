...
func (x *UserCreateBranchError) GetCustomHook() *CustomHookError {
	if x, ok := x.GetError().(*UserCreateBranchError_CustomHook); ok {
		return x.CustomHook
	}
	return nil
}
...
func (m *UserFFBranchError) GetError() isUserFFBranchError_Error {
	if m != nil {
		return m.Error
	}
	return nil
...
func (x *UserFFBranchError) GetCustomHook() *CustomHookError {
	if x, ok := x.GetError().(*UserFFBranchError_CustomHook); ok {
		return x.CustomHook
	}
	return nil
}
...
func (x *UserFFBranchError) GetReferenceUpdate() *ReferenceUpdateError {
	if x, ok := x.GetError().(*UserFFBranchError_ReferenceUpdate); ok {
		return x.ReferenceUpdate
	}
	return nil
}
...
func (x *UserCommitFilesError) GetAccessCheck() *AccessCheckError {
	if x, ok := x.GetError().(*UserCommitFilesError_AccessCheck); ok {
		return x.AccessCheck
	}
	return nil
}
...
func (x *UserCommitFilesError) GetIndexUpdate() *IndexError {
	if x, ok := x.GetError().(*UserCommitFilesError_IndexUpdate); ok {
...
func (x *UserCommitFilesError) GetCustomHook() *CustomHookError {
	if x, ok := x.GetError().(*UserCommitFilesError_CustomHook); ok {
		return x.CustomHook
	}
	return nil
}
...
func file_operations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_operations_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*UserCreateBranchError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_operations_proto_msgTypes[18].Exporter = func(v any, i int) any {
			switch v := v.(*UserRebaseToRefRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_operations_proto_msgTypes[19].Exporter = func(v any, i int) any {
			switch v := v.(*UserRebaseToRefResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_operations_proto_msgTypes[21].Exporter = func(v any, i int) any {
			switch v := v.(*UserFFBranchError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_operations_proto_msgTypes[45].Exporter = func(v any, i int) any {
		...
		file_operations_proto_msgTypes[46].Exporter = func(v any, i int) any {
		...
		file_operations_proto_msgTypes[47].Exporter = func(v any, i int) any {
